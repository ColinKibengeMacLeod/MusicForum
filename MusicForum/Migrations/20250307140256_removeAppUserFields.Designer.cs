...
namespace MusicForum.Migrations
{
    ...
    [Migration("20250307140256_removeAppUserFields")]
    partial class removeAppUserFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicForum.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicForum.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicForum.Models.Comment", b =>
                {
                    b.HasOne("MusicForum.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
